...
new Vue({
  ...
  created: function (){
	  Axios.get('https://127.0.01/assets/scripts/vue/vue-data/categories.js').then( response => {
		  
		 this.categories = response.data
	  })
	  	  Axios.get('https://127.0.01/assets/scripts/vue/vue-data/products.js').then( response => {
			  
		 this.products = response.data
	  })
	  	  Axios.get('https://127.0.01/assets/scripts/vue/vue-data/subcategories.js').then( response => {
