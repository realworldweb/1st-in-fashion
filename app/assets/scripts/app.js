...
new Vue({
  ...
  created: function (){
	  Axios.get('https://www.1stinfashion.co.uk/assets/scripts/vue/vue-data/categories.js').then( response => {
		  
		 this.categories = response.data
	  })
	  	  Axios.get('https://www.1stinfashion.co.uk/assets/scripts/vue/vue-data/products.js').then( response => {
			  
		 this.products = response.data
	  })
	  	  Axios.get('https://www.1stinfashion.co.uk/assets/scripts/vue/vue-data/subcategories.js').then( response => {
